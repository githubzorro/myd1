...
int v4l_capture_setup(struct encode *enc, int width, int height, int fps, int instns);
...
int encoder_allocate_framebuffer(struct encode *enc, int instns);
